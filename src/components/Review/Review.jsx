            ...
            <div className="grid grid-cols-1 md:grid-cols-3 p-5 gap-5 ">
                <div className="flex flex-col pb-4 shadow-md justify-center items-center" >
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-slate-500">I found solution to all my design needs from Creative Tim. I use them as a freelancer in my hobby projects for fun! And its really affordable, very humble guys !!!</p>
                    </div>
                </div>

                <div className="flex flex-col shadow-md justify-center items-center" >
                    <div className="avatar">
                        <div className="w-20 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                ...
                <div className="flex flex-col shadow-md pb-4 justify-center items-center" >
                    <div className="avatar">
                        <div className="w-20 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
